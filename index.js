...
const APP_VERSION = "v-2026-03-29-dashboard-redesign";
...
app.get('/admin/marketing/audience/:restaurantId', requireAdminKey, requireDbReady, async (req, res) => {
...
app.post('/admin/marketing/send', requireAdminKey, requireDbReady, async (req, res) => {
...
app.get('/admin/marketing/campaigns', requireAdminKey, requireDbReady, async (_req, res) => {
  try {
    const result = await pool.query(`
...
app.get('/admin/marketing/campaigns/:id/stats', requireAdminKey, requireDbReady, async (req, res) => {
  try {
    const campaign = await pool.query(
...
app.post('/admin/marketing/triggers', requireAdminKey, requireDbReady, async (req, res) => {
...
app.get('/admin/marketing/triggers/:restaurantId', requireAdminKey, requireDbReady, async (req, res) => {
  try {
    const result = await pool.query(
